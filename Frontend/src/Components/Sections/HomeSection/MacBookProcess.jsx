...
export default function MacbookProcess () {
  return (
    <div className=' w-[363px] md:w-[612px] h-[552px] md:h-[512px] lg:w-[408px] xl:w-[652px] rounded-xl bg-[#232323] border-[#333333] border shadow-sm hover:shadow-PrimaryGold duration-300'>
